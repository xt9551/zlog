...
//#ifdef _MINGWIN
//    #define zc_debug(fmt, args...) printf("[Zdbg]"fmt"\n", ##args)
//    #define zc_warn(fmt, args...) printf("[Zwn]"fmt"\n", ##args)
//#define zc_error(fmt, args...) printf("[Zerr]"fmt"\n", ##args)
//#define zc_profile(fmt, args...) printf("[Zprf]"fmt"\n", ##args)
//#else
